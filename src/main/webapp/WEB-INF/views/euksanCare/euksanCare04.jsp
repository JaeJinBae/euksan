...
<body>
	...
	<section>
		<div class="clinicBg">
			<img src="${pageContext.request.contextPath}/resources/images/euksanCareBg.png">
			<div class="clinicBgText">
				<h1>억산치료법</h1>
				<p>환자 상태에 따른 맞춤 치료를 적용하는 억산한의원</p>
		...
		<div class="contentWrap">
			<div class="sideMenuWrap">
				...
				<div class="sideMenuNav">
					<ul>
						...
						<li><a href="${pageContext.request.contextPath}/euksanCare4" style="color:black;">- 침·뜸·부항</a></li>
			...
			<div class="contentMain">
				<img src="${pageContext.request.contextPath}/resources/images/euksanCare4.png">
			</div>
		</div>
	</section>
	<footer>

	...
	<section>
		...
		<div class="contentWrap">
			<div class="contentMain">
				<div class="tableWrap">
					<form id="f1" method="post" action="mAdviceRegister">
						<table>
							<tr>
							...
							<tr>
								...
								<span class="warn">※ 비공개 선택 시 비밀번호는 필수 입니다.</span></td> 
							</tr>
							<tr>
						...
						<div class="btnWrap">
							<a href="${pageContext.request.contextPath}/mAdvice" class="goListBtn"><button type="button">목록</button></a>
							<input type="submit" value="등록" class="submitBtn" id="registerBtn">
							<a href="${pageContext.request.contextPath}/mAdvice${pageMaker.makeSearch(pageMaker.cri.page)}" class="cancelBtn"><button type="button">취소</button></a>
						</div>
					</form>
				</div><!-- tableWrap end -->
			</div>
